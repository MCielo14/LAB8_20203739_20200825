...
<% ArrayList<Viajes> listaViajes = (ArrayList<Viajes>) request.getAttribute("listaViajes"); %>
<!DOCTYPE html>
<html>
<head>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  ...
  <div class="user-info ml-auto">
    <a href="<%= request.getContextPath()%>/ViajesServlet?action=agregar" class="btn btn-primary mb-4">Agregar Viaje</a>


    <a href="cerrar_sesion.jsp" class="logout-button">Cerrar sesión</a>
  </div>
</nav>
<div class="container">
      ...
      <tr>
        ...
        <td>
          <a class="btn btn-danger"
             href="ViajesServlet?action=borrar&id=<%=v.getIdViaje()%>">
